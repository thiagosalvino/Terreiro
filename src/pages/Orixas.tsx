      ...
      {orixaToDelete && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[60] p-4">
          <div className="bg-white p-6 rounded-2xl shadow-xl max-w-sm w-full">
            ...
            <p className="text-zinc-600 mb-4">Tem certeza que deseja excluir este orixá? Esta ação não pode ser desfeita.</p>
            {deleteError && <p className="text-red-500 text-sm mb-4 p-3 bg-red-50 rounded-lg">{deleteError}</p>}
            <div className="flex justify-end space-x-3">
              <button onClick={() => setOrixaToDelete(null)} className="px-4 py-2 text-zinc-600 hover:bg-zinc-100 rounded-xl transition-colors font-medium">Cancelar</button>
